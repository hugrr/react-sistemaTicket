										...
										<div className="col-md-12 col-md-offset-0 text-left">
											<div className="row row-mt-15em">
												<div
													...
													<br />
													<span className="intro-text-small">bienvenido a Like A Club</span>
									...
									<div className="row">
										<div className="col-md-8 col-md-offset-2 text-center gtco-heading">
											...
											<p>
												...
												organización. Es una herramienta útil para la realización de eventos y/o
												actividades, además de integrar a la comunidad como un participante
												activo, manteniendo así una comunicación fluida. Como un club.
											</p>
										</div>
									</div>
									<div className="row">
